...
export class TranslationUtils {
  static getDecisionName(t: TFunction, decision: string): string {
  ...
  static getDecisionMethodName(t: TFunction, method: string): string {
    if (method === 'Unanimous') {
  ...
  static getCategoryName(t: TFunction, categoryName: string): string {
