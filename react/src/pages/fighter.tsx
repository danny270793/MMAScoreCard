          ...
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <div className="flex items-center gap-3 flex-1">
              <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-lg bg-blue-600 dark:bg-blue-500 flex items-center justify-center">
                <FontAwesomeIcon icon={faUser} className="w-4 h-4 sm:w-5 sm:h-5 text-white" />
              </div>
            ...
            <button
              ...
              disabled={state === 'getting_fighter'}
            ...
            >
              <FontAwesomeIcon icon={faFire} className={`w-4 h-4 ${state === 'getting_fighter' ? 'animate-spin' : ''}`} />
            </button>
          </div>
        </div>
      </header>
