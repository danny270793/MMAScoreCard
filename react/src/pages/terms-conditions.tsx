        ...
        <div className="px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3 flex-1 min-w-0">
              <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-lg bg-orange-600 dark:bg-orange-500 flex items-center justify-center">
                <FontAwesomeIcon icon={faFileAlt} className="w-5 h-5 sm:w-6 sm:h-6 text-white" />
              </div>
